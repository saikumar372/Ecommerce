			...
			<div class="panel panel-default">
	 			...
	 			<div class="panel-body">
	 				<div class="row">
	 						...
	 						<form name="category_form" id="category_form" method="POST" action="<?php echo URL_ADD_CATEGORY;?>" enctype="multipart/form-data">
	 							<div class="col-md-6">
 							...
 							<div class="form-group pull-right">
 									...
 									<button type="submit" name="add_category" value="add_category" class="btn btn-primary" id="add_category">Add Category</button>
